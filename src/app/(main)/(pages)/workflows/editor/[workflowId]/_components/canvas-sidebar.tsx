...
import { CONNECTIONS, EditorCanvasDefaultCardTypes } from "@/lib/contants";
...
import RenderConnectionAccordion from "./render-accordion-connection";
...
function CanvasSidebar({ nodes }: Props) {
